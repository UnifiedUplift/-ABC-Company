...
const Contact = () => {
    ...
    return (
        <section className='w-full'>
            ...
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-4 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                    ...
                    <ul className="mt-12 space-y-8">
                        ...
                        <li className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#fff' viewBox="0 0 368.16 368.16">
                                <path d="M184.08 0c-74.992 0-136 61.008-136 136 0 24.688 11.072 51.24 11.536 52.36 3.576 8.488 10.632 21.672 15.72 29.4l93.248 141.288c3.816 5.792 9.464 9.112 15.496 9.112s11.68-3.32 15.496-9.104l93.256-141.296c5.096-7.728 12.144-20.912 15.72-29.4.464-1.112 11.528-27.664 11.528-52.36 0-74.992-61.008-136-136-136zM293.8 182.152c-3.192 7.608-9.76 19.872-14.328 26.8l-93.256 141.296c-1.84 2.792-2.424 2.792-4.264 0L88.696 208.952c-4.568-6.928-11.136-19.2-14.328-26.808-.136-.328-10.288-24.768-10.288-46.144 0-66.168 53.832-120 120-120s120 53.832 120 120c0 21.408-10.176 45.912-10.28 46.152z" data-original="#fff"></path>
                                <path d="M184.08 64.008c-39.704 0-72 32.304-72 72s32.296 72 72 72 72-32.304 72-72-32.296-72-72-72zm0 128c-30.872 0-56-25.12-56-56s25.128-56 56-56 56 25.12 56 56-25.128 56-56 56z" data-original="#fff"></path>
                            </svg>
                            <a href="javascript:void(0)" className="text-black text-sm ml-4">
                    ...
                    <ul className="flex mt-12 space-x-4">
                        <li className="bg-black hover:bg-gray-600 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                    ...
                    <div className="space-y-4 max-lg:mt-4">
                        <button type="button" className="px-4 py-2 rounded-lg bg-black text-white text-sm tracking-wider font-medium outline-none border-2 border-black mr-4">Web design</button>
                    ...
                    <form className="mt-8 space-y-4">
                        ...
                        <textarea placeholder='Message' rows="6"
                            className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-black"></textarea>
                        <button type='button'
                            className="text-white bg-black hover:bg-gray-600 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#fff' className="mr-2" viewBox="0 0 548.244 548.244">
                                <path fill-rule="evenodd" d="M392.19 156.054 211.268 281.667 22.032 218.58C8.823 214.168-.076 201.775 0 187.852c.077-13.923 9.078-26.24 22.338-30.498L506.15 1.549c11.5-3.697 24.123-.663 32.666 7.88 8.542 8.543 11.577 21.165 7.879 32.666L390.89 525.906c-4.258 13.26-16.575 22.261-30.498 22.338-13.923.076-26.316-8.823-30.728-22.032l-63.393-190.153z" clip-rule="evenodd" data-original="#fff" />
                            </svg>
                            Send Message
                        </button>
                    </form>
        ...
        //                         <div className='bg-black w-[45px] flex justify-center items-center rounded-sm p-2'>
        ...
        //                 </div>
        //                 <button className='bg-black text-black flex gap-2 p-3 font-extrabold rounded-lg items-center justify-center mt-6'>send message</button>
        //             </form>
        ...
        //                     <div className='bg-black p-1 flex justify-center items-center rounded-lg '>
        //                         <Image src={data?.url} alt={data?.url} width={24} height={24} />
        //                     </div>
